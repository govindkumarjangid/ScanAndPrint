        ...
        <div class="container">
          ...
          <div class="body">
            ...
            <div class="field">
              ...
              <div class="value"><a href="tel:${phone}" style="color: #059669; text-decoration: none;">${phone}</a></div>
            </div>
          ...
          <div class="footer">
            Delivered directly to Admin Support: <strong>${recipientEmail}</strong><br>
