    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-3 md:p-4 bg-stone-950/85 backdrop-blur-md">
        <motion.div
          ...
          exit={{ opacity: 0, y: 15 }}
          className="bg-white border-0 sm:border border-stone-200/90 rounded-none sm:rounded-3xl w-full h-[100dvh] sm:h-[92vh] max-w-full sm:max-w-5xl shadow-2xl overflow-hidden flex flex-col text-stone-800"
        >
          {/* TOP HEADER */}
          ...
          <div className="bg-stone-50/90 border-b border-stone-200/80 px-3 sm:px-6 py-2.5 flex flex-wrap items-center justify-between gap-2 shrink-0">
            ...
            <div className="flex items-center bg-white border border-stone-200 p-0.5 rounded-xl shadow-2xs">
              ...
              <button
                ...
                className={`px-2.5 py-1 rounded-lg text-[11px] font-extrabold cursor-pointer transition-all flex items-center gap-1 ${
                  layoutMode === '2in1_book'
                ...
                {pages.map((p) => {
                  ...
                  return (
                    <div
                      ...
                      className={`relative bg-white rounded-xl border-2 transition-all cursor-pointer overflow-hidden group shadow-2xs ${
                        isSelected
                    ...
                    >
                      ...
                      <div className="absolute top-1.5 left-1.5 z-20 flex items-center gap-1">
                        <div
                          ...
                          className={`w-5 h-5 rounded-md flex items-center justify-center cursor-pointer shadow-xs transition-colors ${
                            isSelected ? 'bg-brand text-white' : 'bg-white/90 border border-stone-300 text-transparent'
                          }`}
                        >
            ...
            >
              {isProcessing ? (
                ...
                <>
                  ...
                  <span>Save &amp; Apply PDF Changes</span>
                </>
              )}
            </button>
          </div>
